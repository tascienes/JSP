                    ...
                    <form method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                <label class="col-md-2 control-label" style="margin-top: 15px;"> Kullanıcı Ad</label>
                                <div class="col-md-4">
                                    <input type="text" name="txtKullaniciAd" class="form-control" style="margin-top: 15px;"/>
                                </div>

                            </div>
                            <div class="col-sm-12">
                                <label class="col-md-2 control-label" style="margin-top: 15px;"> Şifre</label>
                                <div class="col-md-4">
                                    <input type="password" class="form-control" name="txtSifre" style="margin-top: 15px;"/>
                                </div>

                            </div>

                            <div class="col-sm-12">
                                <label class="col-md-2 control-label" style="margin-top: 15px;"> ADMİN ŞİFRESİ</label>
                                <div class="col-md-4">
                                    <input type="password" class="form-control" name="txtAdmin" style="margin-top: 15px;"/>
                                </div>
                        ...
                        <%  request.setCharacterEncoding("utf-8");
                            if (request.getParameter("btnKaydet") != null) {
                                ...
                                String AdminSifresi = request.getParameter("txtAdmin");

                                if (AdminSifresi.equals("gdgbolu123")) {

                                    Tablolar.tblkullanicilar nesne = new tblkullanicilar();
                                    nesne.setSifre(Sifre);

                                    nesne.setKullaniciAdi(KullaniciAd);

                                    Islemler.tblkullanicilar_crd.Kaydet(nesne);
                                    response.sendRedirect("Yonetim.jsp");

                                } else {

                                    out.print("Buraya Erişmeye Yetkiniz Yok!!");
                                }
