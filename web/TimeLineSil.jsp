    ...
    <script>
            ...
            function Sil()
            {
                ...
                $.post(
                        ...
                        function (data) {
                            //alert("Response: " + data);
                            window.open("TimeLineSil.jsp","_self");
                        }
                );
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading"> Tüm İçerikler</div>
...
<table class="table table-hover">
                        ...
                        <form method = "POST">
                           ...
                           <% ResultSet rs=Islemler.tblicerik_crd.TumKayitlar();
                                        while(rs.next())
                                        {    
                                 %>
                            ...
                            <tr>
                                ...
                                <td><%= rs.getString("IcerikIsim")%></td>
                                <td> <button  type="button"  id="btnSil" value="<%= rs.getInt("pkIcerikID")%>" name="btnSil" onclick="Goster();">Sil</button>     </td>
                                 <%
                                        }
                                        %>
                            </tr>
