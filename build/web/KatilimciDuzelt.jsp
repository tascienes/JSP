...
<%  request.setCharacterEncoding("utf-8");
    ...
    tblkatilimcilar katilimci = new tblkatilimcilar();
    if (session.getAttribute("Oturum") == null) {
        ...
        katilimci = Islemler.tblkatilimcilar_crd.idyeGoreKayitObjeGetir(id);
                ...
                <div class="panel-body">
                    <form method="post" class="form-horizontal">
                        <div class="form-group">
                            <div class="col-sm-4">
                                <label class="col-md-4 control-label"> Katılımcı Adı :</label>
                                <div class="col-md-8">
                                    <input type="text" name="txtAdSoyad" class="form-control "  value="<%= katilimci.getKatilimciAdi()%>"  />
                                </div>
                        ...
                        <%  request.setCharacterEncoding("utf-8");
                            if (request.getParameter("btnKaydet") != null) {
                                ...
                                String AdSoyad = request.getParameter("txtAdSoyad");

                                Tablolar.tblkatilimcilar nesne = new tblkatilimcilar();
                                nesne.setKatilimciAdi(AdSoyad);
                                nesne.setpkKatilimciID(katilimci.getpkKatilimciID());
                                Islemler.tblkatilimcilar_crd.Duzelt(nesne);
